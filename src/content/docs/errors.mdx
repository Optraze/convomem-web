...
Capture scales with your plan, and **each agent gets its own budget** — a busy
support agent can't eat into what your sales agent has left. Both run at the
full rate for your plan:
...
Each capture call enqueues background AI work, so send a few conversation turns
per call rather than one call per message. It costs less, goes further against
your limit, and produces better memories than one-line captures.
</Callout>
