  ...
  return (
    <div className="rounded-xl border border-border-strong bg-surface overflow-hidden">
      ...
      <div className="px-4 py-3.5 border-b border-border">
        <p
          className="font-mono text-hint text-[10px] tracking-[0.18em] uppercase mb-2"
        >
          incoming · chat
        </p>
        <p
      ...
      <div className="px-4 py-3.5">
        <div className="flex items-center justify-between mb-2.5">
          <p
            className="font-mono text-hint text-[10px] tracking-[0.18em] uppercase"
          >
            extracted
          </p>
          <span
            className="font-mono inline-flex items-center gap-1 text-hint text-[9px] tracking-[0.1em] uppercase"
          >
        ...
        <ul className="space-y-2">
          {FACTS.map((l, i) => (
            ...
            >
              ...
              <span
                className="font-mono text-hint text-[10px] whitespace-nowrap"
              >
                {l.type}
              </span>
            </motion.li>
